...
public class AutomateLines {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (quantityTestCases <= toHereTcs) {
            ...
            if(changeTypeTcs == 1){
            ...
            } else if (changeTypeTcs == 2) {
                testCase = "Validar los valores límites del Pattern, mínimos y máximos del campo <" + headerValidation.fields[argNumber] + "> y que muestre el código de respuesta 200" ;
                gherkin = "\n\tDado que se enviará una solicitud a la api\n" +
                        "\tCuando completo el campo mencionado con un valor validando Pattern, mínimos y máximos\n" +
                        "\tY selecciono el método \n" +
                        "\tY envío la petición\n" +
                        "\tEntonces obtengo un código de respuesta 200\n\n";
            } else if (changeTypeTcs == 3 && isRequired == true) {
                ...
                gherkin = "\n\tDado que se enviará una solicitud a la api\n" +
                        ...
                        "\tY envío la petición\n" +
                        "\tEntonces obtengo un código de respuesta 400\n\n";
            } else if (changeTypeTcs == 4 && isRequired == true) {
                testCase = "Validar que al ingresar vacío en el campo <" + headerValidation.fields[argNumber] + "> este muestre el código de error 400" ;
                gherkin = "\n\tDado que se enviará una solicitud a la api\n" +
                        "\tCuando completo el campo mencionado con un valor vacío\n" +
                        "\tY selecciono el método \n" +
                        "\tY envío la petición\n" +
                        "\tEntonces obtengo un código de respuesta 400\n\n";
            } else {
